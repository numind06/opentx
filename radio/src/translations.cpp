...
const pm_char STR_BLCOLOR[]  PROGMEM = TR_BLCOLOR;
  ...
  const pm_char STR_BINDING_MODE1[] PROGMEM = TR_BINDING_MODE1;
  const pm_char STR_BINDING_MODE2[] PROGMEM = TR_BINDING_MODE2;
  const pm_char STR_BINDING_MODE3[] PROGMEM = TR_BINDING_MODE3;
  const pm_char STR_BINDING_MODE4[] PROGMEM = TR_BINDING_MODE4;
