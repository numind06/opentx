...
extern const pm_char STR_BINDING_MODE1[];
extern const pm_char STR_BINDING_MODE2[];
extern const pm_char STR_BINDING_MODE3[];
extern const pm_char STR_BINDING_MODE4[];
